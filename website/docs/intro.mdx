...
[^4]: 你应该知道书籍《[Kubernetes in  Action, edition 1](https://www.manning.com/books/kubernetes-in-action)》中前两部分（PART1，PART2）所要传达的知识；你需要知道Kubernetes集群的[组成及架构](https://kubernetes.io/docs/concepts/overview/components/)；你也有使用[kubectl](https://kubernetes.io/docs/reference/kubectl/)工具管理Kubernetes集群的经验。
